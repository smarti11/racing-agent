...
print("=" * 70)
print("DAILY DOUBLE WHAT-IF ANALYSIS — PICK #1 (Apr 17-19)")
...
track_dates = conn.execute(
    ...
    "FROM races r WHERE r.race_date >= '2026-04-17' AND r.race_date <= '2026-04-19' "
...
leg1_wins = conn.execute(
    ...
    "WHERE r.race_date >= '2026-04-17' AND ap.rank=1 AND ap.result='WIN'"
).fetchone()[0]
